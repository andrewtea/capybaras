export const playerCooldowns = new Map<string, number>();
...
export const itemIcons: Record<string, string> = {
    ...
    "asb_cb:cowboy_hat": "textures/items/cowboy_hat_icon"
};

export const allowedHeadItems = new Set([
    // Vanilla items
...
export const allowedBodyItems = new Set([
    // Vanilla items
